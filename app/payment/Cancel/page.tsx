  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl border border-gray-100 shadow-xl text-center">
        ...
        <h2 className="text-2xl font-black text-gray-900">Payment Cancelled</h2>
        <p className="text-gray-500 text-sm mt-2 mb-6">
          The transaction was cancelled or could not be completed. You can try again from your dashboard.
        </p>
        <Link
